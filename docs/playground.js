(function (global, factory) {
  ...
  var IntlSupportedValuesOf = globalThis.Intl.supportedValuesOf;
  ...
  function GetAvailableNamedTimeZoneIdentifier(identifier) {
    ...
    if (canonicalTimeZoneIdsCache === undefined) {
      var canonicalTimeZoneIds = IntlSupportedValuesOf === null || IntlSupportedValuesOf === void 0 ? void 0 : IntlSupportedValuesOf('timeZone');
      canonicalTimeZoneIdsCache = canonicalTimeZoneIds ? new Map(canonicalTimeZoneIds.map(function (id) {
        return [ASCIILowercase(id), id];
      })) : null;
    }
    ...
    var standardCase = _toConsumableArray(lower).map(function (c, i) {
      return i === 0 || '/-_'.includes(lower[i - 1]) ? c.toUpperCase() : c;
    }).join('');
  ...
  function NanosecondsToDays(nanoseconds, zonedRelativeTo) {
    ...
    var startNs = GetSlot(zonedRelativeTo, EPOCHNANOSECONDS);
    var start = GetSlot(zonedRelativeTo, INSTANT);
  ...
  function BalanceTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit) {
    var result = BalancePossiblyInfiniteTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit);
  ...
  function BalanceTimeDurationRelative(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit, zonedRelativeTo) {
    var result = BalancePossiblyInfiniteTimeDurationRelative(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit, zonedRelativeTo);
    if (result === 'positive overflow' || result === 'negative overflow') {
      throw new RangeError('Duration out of range');
    }
    return result;
  ...
  function BalancePossiblyInfiniteTimeDurationRelative(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit, zonedRelativeTo) {
    var endNs = AddZonedDateTime(GetSlot(zonedRelativeTo, INSTANT), GetSlot(zonedRelativeTo, TIME_ZONE), GetSlot(zonedRelativeTo, CALENDAR), 0, 0, 0, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds);
    var startNs = GetSlot(zonedRelativeTo, EPOCHNANOSECONDS);
    nanoseconds = endNs.subtract(startNs);
    if (largestUnit === 'year' || largestUnit === 'month' || largestUnit === 'week' || largestUnit === 'day') {
      var _NanosecondsToDays = NanosecondsToDays(nanoseconds, zonedRelativeTo);
    ...
    var _BalancePossiblyInfin = BalancePossiblyInfiniteTimeDuration(0, 0, 0, 0, 0, 0, nanoseconds, largestUnit);
    hours = _BalancePossiblyInfin.hours;
    minutes = _BalancePossiblyInfin.minutes;
    seconds = _BalancePossiblyInfin.seconds;
    milliseconds = _BalancePossiblyInfin.milliseconds;
    microseconds = _BalancePossiblyInfin.microseconds;
    nanoseconds = _BalancePossiblyInfin.nanoseconds;
    return {
      days: days,
      hours: hours,
      minutes: minutes,
      ...
      case 'day':
        {
          ...
          var _days = DayOfYear(larger.year, larger.month, larger.day) - DayOfYear(smaller.year, smaller.month, smaller.day);
          for (var year = smaller.year; year < larger.year; ++year) {
            _days += LeapYear(year) ? 366 : 365;
          }
          var weeks = 0;
          if (largestUnit === 'week') {
            weeks = MathFloor$1(_days / 7);
            _days %= 7;
          }
          weeks *= _sign;
          _days *= _sign;
  ...
  function DifferenceISODateTime(y1, mon1, d1, h1, min1, s1, ms1, µs1, ns1, y2, mon2, d2, h2, min2, s2, ms2, µs2, ns2, calendar, largestUnit, options) {
    ...
    if (dateSign === -timeSign) {
      ...
      var _BalanceTimeDuration = BalanceTimeDuration(-timeSign, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit);
      hours = _BalanceTimeDuration.hours;
      minutes = _BalanceTimeDuration.minutes;
      seconds = _BalanceTimeDuration.seconds;
      milliseconds = _BalanceTimeDuration.milliseconds;
      microseconds = _BalanceTimeDuration.microseconds;
      nanoseconds = _BalanceTimeDuration.nanoseconds;
    }
    ...
    var _BalanceTimeDuration2 = BalanceTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit);
    days = _BalanceTimeDuration2.days;
    hours = _BalanceTimeDuration2.hours;
    minutes = _BalanceTimeDuration2.minutes;
    seconds = _BalanceTimeDuration2.seconds;
    milliseconds = _BalanceTimeDuration2.milliseconds;
    microseconds = _BalanceTimeDuration2.microseconds;
    nanoseconds = _BalanceTimeDuration2.nanoseconds;
    return {
      years: years,
      months: months,
      weeks: weeks,
  ...
  function DifferenceZonedDateTime(ns1, ns2, timeZone, calendar, largestUnit, options) {
    ...
    var _BalanceTimeDuration3 = BalanceTimeDuration(0, 0, 0, 0, 0, 0, timeRemainderNs, 'hour'),
      hours = _BalanceTimeDuration3.hours,
      minutes = _BalanceTimeDuration3.minutes,
      seconds = _BalanceTimeDuration3.seconds,
      milliseconds = _BalanceTimeDuration3.milliseconds,
      microseconds = _BalanceTimeDuration3.microseconds,
      nanoseconds = _BalanceTimeDuration3.nanoseconds;
    return {
      years: years,
      months: months,
      weeks: weeks,
  ...
  function DifferenceTemporalPlainDateTime(operation, plainDateTime, other, options) {
    ...
    var _BalanceTimeDuration4 = BalanceTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, settings.largestUnit);
    days = _BalanceTimeDuration4.days;
    hours = _BalanceTimeDuration4.hours;
    minutes = _BalanceTimeDuration4.minutes;
    seconds = _BalanceTimeDuration4.seconds;
    milliseconds = _BalanceTimeDuration4.milliseconds;
    microseconds = _BalanceTimeDuration4.microseconds;
    nanoseconds = _BalanceTimeDuration4.nanoseconds;
    var Duration = GetIntrinsic('%Temporal.Duration%');
  ...
  function DifferenceTemporalPlainTime(operation, plainTime, other, options) {
    ...
    var _BalanceTimeDuration5 = BalanceTimeDuration(0, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, settings.largestUnit);
    hours = _BalanceTimeDuration5.hours;
    minutes = _BalanceTimeDuration5.minutes;
    seconds = _BalanceTimeDuration5.seconds;
    milliseconds = _BalanceTimeDuration5.milliseconds;
    microseconds = _BalanceTimeDuration5.microseconds;
    nanoseconds = _BalanceTimeDuration5.nanoseconds;
    var Duration = GetIntrinsic('%Temporal.Duration%');
    return new Duration(0, 0, 0, 0, sign * hours, sign * minutes, sign * seconds, sign * milliseconds, sign * microseconds, sign * nanoseconds);
  }
  ...
  function AddDuration(y1, mon1, w1, d1, h1, min1, s1, ms1, µs1, ns1, y2, mon2, w2, d2, h2, min2, s2, ms2, µs2, ns2, relativeTo) {
    ...
    if (!relativeTo) {
      ...
      var _BalanceTimeDuration6 = BalanceTimeDuration(d1 + d2, bigInt(h1).add(h2), bigInt(min1).add(min2), bigInt(s1).add(s2), bigInt(ms1).add(ms2), bigInt(µs1).add(µs2), bigInt(ns1).add(ns2), largestUnit);
      days = _BalanceTimeDuration6.days;
      hours = _BalanceTimeDuration6.hours;
      minutes = _BalanceTimeDuration6.minutes;
      seconds = _BalanceTimeDuration6.seconds;
      milliseconds = _BalanceTimeDuration6.milliseconds;
      microseconds = _BalanceTimeDuration6.microseconds;
      nanoseconds = _BalanceTimeDuration6.nanoseconds;
      ...
      // Signs of date part and time part may not agree; balance them together
      var _BalanceTimeDuration7 = BalanceTimeDuration(days, bigInt(h1).add(h2), bigInt(min1).add(min2), bigInt(s1).add(s2), bigInt(ms1).add(ms2), bigInt(µs1).add(µs2), bigInt(ns1).add(ns2), largestUnit);
      days = _BalanceTimeDuration7.days;
      hours = _BalanceTimeDuration7.hours;
      minutes = _BalanceTimeDuration7.minutes;
      seconds = _BalanceTimeDuration7.seconds;
      milliseconds = _BalanceTimeDuration7.milliseconds;
      microseconds = _BalanceTimeDuration7.microseconds;
      nanoseconds = _BalanceTimeDuration7.nanoseconds;
    } else {
  ...
  function AddDurationToOrSubtractDurationFromPlainYearMonth(operation, yearMonth, durationLike, options) {
    ...
    var _BalanceTimeDuration8 = BalanceTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, 'day');
    days = _BalanceTimeDuration8.days;
    options = GetOptionsObject(options);
    var calendar = GetSlot(yearMonth, CALENDAR);
    var fieldNames = CalendarFields(calendar, ['monthCode', 'year']);
  ...
  function AdjustRoundedDurationDays(years, months, weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, increment, unit, roundingMode, relativeTo) {
    ...
    var oneDayLess = timeRemainderNs.subtract(dayLengthNs);
    if (oneDayLess.multiply(direction).geq(0)) {
      ...
      var _RoundDuration7 = RoundDuration(years, months, weeks, days, 0, 0, 0, 0, 0, oneDayLess.toJSNumber(), increment, unit, roundingMode);
      hours = _RoundDuration7.hours;
      minutes = _RoundDuration7.minutes;
      seconds = _RoundDuration7.seconds;
      milliseconds = _RoundDuration7.milliseconds;
      microseconds = _RoundDuration7.microseconds;
      nanoseconds = _RoundDuration7.nanoseconds;
      var _BalanceTimeDuration9 = BalanceTimeDuration(0, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, 'hour');
      hours = _BalanceTimeDuration9.hours;
      minutes = _BalanceTimeDuration9.minutes;
      seconds = _BalanceTimeDuration9.seconds;
      milliseconds = _BalanceTimeDuration9.milliseconds;
      microseconds = _BalanceTimeDuration9.microseconds;
      nanoseconds = _BalanceTimeDuration9.nanoseconds;
    }
    return {
      years: years,
      months: months,
  ...
  function RoundDuration(years, months, weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, increment, unit, roundingMode) {
    ...
    if (unit === 'year' || unit === 'month' || unit === 'week' || unit === 'day') {
      ...
      var deltaDays;
      if (zonedRelativeTo) {
        var intermediate = MoveRelativeZonedDateTime(zonedRelativeTo, years, months, weeks, days);
        ...
        var _nanoseconds$divmod7 = nanoseconds.divmod(DAY_NANOS);
        deltaDays = _nanoseconds$divmod7.quotient;
        nanoseconds = _nanoseconds$divmod7.remainder;
      ...
      case 'year':
        {
          ...
          var _nanoseconds$divmod8 = nanoseconds.divmod(divisor),
            quotient = _nanoseconds$divmod8.quotient,
            remainder = _nanoseconds$divmod8.remainder;
      ...
      case 'month':
        {
          ...
          var _nanoseconds$divmod9 = nanoseconds.divmod(_divisor),
            _quotient = _nanoseconds$divmod9.quotient,
            _remainder = _nanoseconds$divmod9.remainder;
      ...
      case 'week':
        {
          ...
          var _nanoseconds$divmod10 = nanoseconds.divmod(_divisor2),
            _quotient2 = _nanoseconds$divmod10.quotient,
            _remainder2 = _nanoseconds$divmod10.remainder;
      ...
      case 'day':
        {
          ...
          var _nanoseconds$divmod11 = nanoseconds.divmod(_divisor3),
            _quotient3 = _nanoseconds$divmod11.quotient,
            _remainder3 = _nanoseconds$divmod11.remainder;
      ...
      case 'hour':
        {
          ...
          var _nanoseconds$divmod12 = nanoseconds.divmod(_divisor4),
            _quotient4 = _nanoseconds$divmod12.quotient,
            _remainder4 = _nanoseconds$divmod12.remainder;
      ...
      case 'minute':
        {
          ...
          var _nanoseconds$divmod13 = nanoseconds.divmod(_divisor5),
            _quotient5 = _nanoseconds$divmod13.quotient,
            _remainder5 = _nanoseconds$divmod13.remainder;
      ...
      case 'second':
        {
          ...
          var _nanoseconds$divmod14 = nanoseconds.divmod(_divisor6),
            _quotient6 = _nanoseconds$divmod14.quotient,
            _remainder6 = _nanoseconds$divmod14.remainder;
      ...
      case 'millisecond':
        {
          ...
          var _nanoseconds$divmod15 = nanoseconds.divmod(_divisor7),
            _quotient7 = _nanoseconds$divmod15.quotient,
            _remainder7 = _nanoseconds$divmod15.remainder;
      ...
      case 'microsecond':
        {
          ...
          var _nanoseconds$divmod16 = nanoseconds.divmod(_divisor8),
            _quotient8 = _nanoseconds$divmod16.quotient,
            _remainder8 = _nanoseconds$divmod16.remainder;
  ...
  var TZ_CANONICAL = Symbol('timezone-canonical');
  var TZ_ORIGINAL = Symbol('timezone-original');
  ...
  function DateTimeFormat() {
    ...
    if (timeZoneOption === undefined) {
      ...
      var id = ToString$1(timeZoneOption);
      ...
      var record = GetAvailableNamedTimeZoneIdentifier(id);
  ...
  function extractOverrides(temporalObj, main) {
    ...
    if (IsTemporalYearMonth(temporalObj)) {
      ...
      return {
        instant: GetInstantFor(main[TZ_CANONICAL], _datetime, 'compatible'),
    ...
    if (IsTemporalMonthDay(temporalObj)) {
      ...
      return {
        instant: GetInstantFor(main[TZ_CANONICAL], _datetime2, 'compatible'),
    ...
    if (IsTemporalDate(temporalObj)) {
      ...
      return {
        instant: GetInstantFor(main[TZ_CANONICAL], _datetime3, 'compatible'),
    ...
    if (IsTemporalDateTime(temporalObj)) {
      ...
      return {
        instant: GetInstantFor(main[TZ_CANONICAL], _datetime4, 'compatible'),
  ...
  var Calendar = /*#__PURE__*/function () {
    ...
    _createClass(Calendar, [{
      ...
      value: function mergeFields(fields, additionalFields) {
        if (!IsTemporalCalendar(this)) throw new TypeError('invalid receiver');
        var fieldsCopy = SnapshotOwnProperties(ToObject$1(fields), null, [], [undefined]);
        var additionalFieldsCopy = SnapshotOwnProperties(ToObject$1(additionalFields), null, [], [undefined]);
      ...
      value: function dateAdd(date, duration) {
        ...
        options = GetOptionsObject(options);
        var overflow = ToTemporalOverflow(options);
        var _ES$BalanceTimeDurati = BalanceTimeDuration(GetSlot(duration, DAYS), GetSlot(duration, HOURS), GetSlot(duration, MINUTES), GetSlot(duration, SECONDS), GetSlot(duration, MILLISECONDS), GetSlot(duration, MICROSECONDS), GetSlot(duration, NANOSECONDS), 'day'),
          days = _ES$BalanceTimeDurati.days;
        var id = GetSlot(this, CALENDAR_ID);
   ...
   */
  var makeHelperSameMonthDayAsGregorian = function makeHelperSameMonthDayAsGregorian(id, originalEras) {
    var base = makeHelperGregorian(id, originalEras);
    return ObjectAssign$1(base, {
      isoToCalendarDate: function isoToCalendarDate(isoDate) {
  ...
  var helperRoc = ObjectAssign$1({}, makeHelperSameMonthDayAsGregorian('roc', [{
    name: 'minguo',
    isoEpoch: {
      year: 1912,
      month: 1,
  ...
  var helperBuddhist = ObjectAssign$1({}, makeHelperSameMonthDayAsGregorian('buddhist', [{
    name: 'be',
    hasYearZero: true,
    isoEpoch: {
      year: -543,
  ...
  var helperGregory = ObjectAssign$1({}, makeHelperSameMonthDayAsGregorian('gregory', [{
    name: 'ce',
    isoEpoch: {
      year: 1,
      month: 1,
  ...
  var Duration = /*#__PURE__*/function () {
    ...
    _createClass(Duration, [{
      ...
      value: function round(roundTo) {
        ...
        var maximum = maximumIncrements[smallestUnit];
        if (maximum !== undefined) ValidateTemporalRoundingIncrement(roundingIncrement, maximum, false);
        var _ES$UnbalanceDateDura = UnbalanceDateDurationRelative(years, months, weeks, days, largestUnit, relativeTo);
        years = _ES$UnbalanceDateDura.years;
        months = _ES$UnbalanceDateDura.months;
        weeks = _ES$UnbalanceDateDura.weeks;
        days = _ES$UnbalanceDateDura.days;
        ...
        if (IsTemporalZonedDateTime(relativeTo)) {
          ...
          var _ES$BalanceTimeDurati = BalanceTimeDurationRelative(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit, relativeTo);
          days = _ES$BalanceTimeDurati.days;
          hours = _ES$BalanceTimeDurati.hours;
          minutes = _ES$BalanceTimeDurati.minutes;
          seconds = _ES$BalanceTimeDurati.seconds;
          milliseconds = _ES$BalanceTimeDurati.milliseconds;
          microseconds = _ES$BalanceTimeDurati.microseconds;
          nanoseconds = _ES$BalanceTimeDurati.nanoseconds;
        } else {
          var _ES$BalanceTimeDurati2 = BalanceTimeDuration(days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds, largestUnit);
          days = _ES$BalanceTimeDurati2.days;
          hours = _ES$BalanceTimeDurati2.hours;
          minutes = _ES$BalanceTimeDurati2.minutes;
          seconds = _ES$BalanceTimeDurati2.seconds;
          milliseconds = _ES$BalanceTimeDurati2.milliseconds;
          microseconds = _ES$BalanceTimeDurati2.microseconds;
          nanoseconds = _ES$BalanceTimeDurati2.nanoseconds;
        }
        var _ES$BalanceDateDurati = BalanceDateDurationRelative(years, months, weeks, days, largestUnit, relativeTo);
        years = _ES$BalanceDateDurati.years;
        months = _ES$BalanceDateDurati.months;
        weeks = _ES$BalanceDateDurati.weeks;
        days = _ES$BalanceDateDurati.days;
        return new Duration(years, months, weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds);
      }
    }, {
      key: "total",
      value: function total(totalOf) {
        ...
        var _ES$UnbalanceDateDura2 = UnbalanceDateDurationRelative(years, months, weeks, days, unit, relativeTo);
        years = _ES$UnbalanceDateDura2.years;
        months = _ES$UnbalanceDateDura2.months;
        weeks = _ES$UnbalanceDateDura2.weeks;
        days = _ES$UnbalanceDateDura2.days;
        var balanceResult;
        if (IsTemporalZonedDateTime(relativeTo)) {
          var intermediate = MoveRelativeZonedDateTime(relativeTo, years, months, weeks, 0);
        ...
        var _balanceResult = balanceResult;
        days = _balanceResult.days;
        hours = _balanceResult.hours;
        minutes = _balanceResult.minutes;
        seconds = _balanceResult.seconds;
        milliseconds = _balanceResult.milliseconds;
        microseconds = _balanceResult.microseconds;
        nanoseconds = _balanceResult.nanoseconds;
      ...
      value: function toString() {
        ...
        var _ES$ToSecondsStringPr = ToSecondsStringPrecisionRecord(smallestUnit, digits),
          ...
          unit = _ES$ToSecondsStringPr.unit,
          increment = _ES$ToSecondsStringPr.increment;
        var _ES$RoundDuration3 = RoundDuration(0, 0, 0, 0, 0, 0, GetSlot(this, SECONDS), GetSlot(this, MILLISECONDS), GetSlot(this, MICROSECONDS), GetSlot(this, NANOSECONDS), increment, unit, roundingMode),
      ...
      value: function compare(one, two) {
        ...
        if (y1 !== 0 || y2 !== 0 || mon1 !== 0 || mon2 !== 0 || w1 !== 0 || w2 !== 0) {
          var _ES$UnbalanceDateDura3 = UnbalanceDateDurationRelative(y1, mon1, w1, d1, 'day', relativeTo);
          d1 = _ES$UnbalanceDateDura3.days;
          var _ES$UnbalanceDateDura4 = UnbalanceDateDurationRelative(y2, mon2, w2, d2, 'day', relativeTo);
          d2 = _ES$UnbalanceDateDura4.days;
        }
  ...
  var ZonedDateTime = /*#__PURE__*/function () {
    ...
    _createClass(ZonedDateTime, [{
      ...
      value: function toLocaleString() {
        ...
        var timeZoneIdentifier = ToTemporalTimeZoneIdentifier(GetSlot(this, TIME_ZONE));
